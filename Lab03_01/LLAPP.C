...
void * CreateData1 ( void * data )
{
    ...
    memcpy (new_data->element, (ElementType *) data ,sizeof(ElementType));
...
{
    return ( strcmp ( ((pND1) first)->element->telnum,
                      ((pND1) second)->element->telnum ) );
}
...
{
    return ( strcmp ( ((pND2) first)->element->telnum,
                      ((pND2) second)->element->telnum) );
}
